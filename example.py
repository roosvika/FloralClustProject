...
# vocluster_part = voc_louvain.get_partition(data_path=data_path,graph_threshold=0.9, addaptive_threshold=0.95)
# create_smelling_compounds_hypothesises(data, data_path, vocluster_part, 'Results/ErucariaCombined/Smelling/MSP')
