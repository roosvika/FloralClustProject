...
res_df = pd.DataFrame(
    columns=['Method', 'RI', 'ARI', 'NMI', 'Purity', 'SmellingRI', 'SmellingARI', 'SmellingNMI', 'SmellingPurity'])
# RAMClust
print('RAMClust')
...
print(res_df)
res_df.to_csv('Results/clustering_similarity_with_compound_separation_modified.csv')
