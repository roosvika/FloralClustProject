...
for (graph_threshold, addaptive_threshold) in thresholds_pairs:
    ...
    seven_part = voc_louvain.get_partition(data_path, graph_threshold=graph_threshold, addaptive_threshold=addaptive_threshold)
    ...
    data = load_xcms.get_normilezed_xcms_df(data_path=data_path)
    eight_part = voc_louvain.get_partition(data_path, graph_threshold=graph_threshold, addaptive_threshold=addaptive_threshold)
